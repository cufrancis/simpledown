...
<div class="hero-unit">
    <div class="reg login">
        <form action="<?php echo base_url('login/do_login') ?>" method="post" name="login_form">
            <dl>
                <div style="height:17px; overflow:hidden"></div>
                <dd><span class="title">登录账号：</span><input class="reg_input" name="t_UserName" type="text" /></dd>
                <dd><span class="title">登录密码：</span><input class="reg_input" name="t_UserPass" type="password"/></dd>
            </dl>
            <div class="f_reg_but"><input name="login" type="submit" value="登录" class="l_button"/></div>
        </form>                      
    </div>
</div>
</div>
