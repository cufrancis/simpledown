...
<div class="container">       
	<div class="hero-unit">
        ...
        <div class="reg">
        <dl>
            <dt class="f14 b">新增分类</dt>
            <form action="<?php echo base_url()."system/settype"; ?>" method="post" name="form1" id="form1">
            <dd><span class="title">新分类名称：</span><input class="reg_input" name="type_name" id="type_name" type="text"/></dd>
            <dd><span class="title">新分类序号：</span><input class="reg_input" name="type_id" id="type_id" type="text"/></dd>
            <input type="submit" value="添加分类"/>
            </form> 
            <dd>    
                <dt class="f14 b">分类管理</dt>
                <table class='table'>
                    <tr>
                        <th>操作</th><th>分类</th><th>序号</th>
                    </tr>
                    <?php foreach ($hbdx_baseinfo as $type_item): ?>
                        <tr><td><a href="<?php echo base_url()."system/del_type/".$type_item['id'] ?>">删除</a> <a href="javascript:void()" onClick="javascript:UpdateType('<?php echo $type_item['code']; ?>','<?php echo $type_item['tagsecond']; ?>')">修改</a></td><td><?php echo $type_item['code'] ?></td><td><?php echo $type_item['tagsecond'] ?></td></tr>
                    <?php endforeach ?>
                </table>
            </dd>
        </dl>                            
